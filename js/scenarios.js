const ScenarioData = {
    'stage1': {
        ...
        // ▼追加：ブリーフィング用のテキスト
        briefing: "あなたは地震発生時、自宅にいる想定です。<br><br>突如として巨大な揺れがあなたを襲います。自分や周囲の命を守るための、一瞬の判断を行ってください。",
        startScene: 's1_1',
        scenes: {
            's1_1': {
                ...
                options: [
                    ...
                    },
                    {
                        ...
                        fb: { isGood: true, title: "初動対応", reason: "強い揺れの最中は、火を消しに行く、外へ飛び出すといった行動で、転倒や落下物によるけがの危険が高まります。
まずはテーブルの下などで頭を守り、揺れがおさまってから火元や避難経路を確認しましょう。", knowledge: "能登地震でも、家具の転倒や屋根瓦の落下による負傷が相次ぎました。" } 
                    }
                ]
            },
            ...
            's2_5': {
                ...
                options: [
                    ...
                    { 
                        ...
                        fb: { isGood: false, isWarning: true,title: "口腔ケア", reason: "口の中は綺麗になりますが、貴重な飲料水を消費しすぎです。水不足での脱水症状は命に関わります。災害時は『少量の水（約30ml）』でケアする方法を身につけましょう", ifWrong: "口の中が不潔になると、命に関わる病気のリスクが高まります。", knowledge: "資料によると、発災後12週間にわたり肺炎死亡リスクが増加したというデータがあります。" } 
                    },
                    { 
